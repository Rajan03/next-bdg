...
export default function SignInPage() {
    ...
    React.useEffect(() => {
        if (session && session.user) {
            ...
            status === 'unauthenticated' &&  setLoading(false);
        }
    }, [session]);
    ...
    return (
        <section className="h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center items-center">
            <div className="max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:gap-20 lg:py-16 lg:grid-cols-12">
                    ...
                    <div>
                        <a href="#"
                           className="inline-flex items-center mb-6 text-2xl font-semibold text-gray-900 lg:mb-10 dark:text-white">
                            <Image className="w-8 h-8 mr-2" height={50} width={50}
                        ...
                        <div className="flex pt-8">
                            ...
                            <div>
                                ...
                                <p className="mb-2 font-light text-gray-500 dark:text-gray-400">Host code that you
                                    don&quot;t
                                    want to share with the world in private.</p>
                            </div>
                        </div>
                        <div className="flex pt-8">
                            <svg className="w-5 h-5 mr-2 text-primary-600 shrink-0" fill="currentColor"
                            ...
                            <div>
                                ...
                                <p className="mb-2 font-light text-gray-500 dark:text-gray-400">Flowbite is trusted by
                                    ambitious startups and enterprises of every size.</p>
                            </div>
                        </div>
                    </div>
                    <nav>
                ...
                <div className="w-full col-span-6 mx-auto bg-white rounded-lg shadow dark:bg-gray-800 md:mt-0 sm:max-w-lg xl:p-0">
                    <div className="p-6 space-y-4 lg:space-y-6 sm:p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6" action="#">
                            <div>
                                <label htmlFor="email"
